...
class Tetris:
    ...
    def get_state_properties(self, board):
        ...
        return jnp.array([lines_cleared, holes, bumpiness, height], dtype=jnp.float32)
    ...
    def step(self, action, render=True, video=None):
        ...
        score = 1 + ((4 * lines_cleared) ** 2) * self.width
        self.score += score
        self.tetrominoes += 1
    ...
    def render(self, video=None):
        ...
        # Uncomment this part if run on local machine
